...
describe("Board", () => {
    ...
    */
    describe("PUT/:boardId/teams board", () => {
        ...
        it("should NOT ADD a member to board if the teamId for the team is malformed", (done) => {
            chai.request(server)
                .put(`/api/boards/${board._id}/members`)
                .set("Authorization", header)
