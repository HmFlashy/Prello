...
router.delete("/:boardId/members/:userId", boardsValidator.deleteBoardMemberValidator, checkRequest, checkRightsFromBoard(["in:Board", "status:Board:Admin"]), require('./deleteBoardMember'));
