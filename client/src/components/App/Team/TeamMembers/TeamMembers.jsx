        ...
        return (
            <div className="team-members">
                ...
                <Container className="action-team-members">
                    <div className="team-members-header"><Input placeholder='Search...' value={this.props.queryMember}
                                                                onChange={this.updateSearch}/>
                        <Button className="leave-team-button" color="red" onClick={() => {
                            this.props.history.push("/home");
                            this.props.deleteMember(this.props.user._id)
                        }}>Leave Team</Button></div>
                    {this.props.isAdmin
                                        ...
                                        return (
                                            <Table.Row key={member.member._id}>
                                                <Table.Cell className="member-cell">
                                                    ...
                                                    {this.props.isAdmin
                                                        ? member.member._id === this.props.user._id ?
                                                            <Button className="remove-member-button" color="red"
                                                                    onClick={async () => {
                                                                        await this.props.deleteMember(member.member._id);
                                                                        this.props.history.push("/home");
                                                                    }}>Leave</Button>
                                                            : <Button className="remove-member-button" color="red"
                                                                      onClick={() => this.props.deleteMember(member.member._id)}>Remove</Button>
                                                        : member.member._id === this.props.user._id ?
                                                            <Button className="remove-member-button" color="red"
                                                                    onClick={async () => {
                                                                        await this.props.deleteMember(member.member._id);
