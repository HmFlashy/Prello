        ...
        return (
            <div>
                ...
                <Modal.Actions>
                    ...
                    <Button icon='check' content='Validate' color='green' onClick={() => this.state.value !== "" && this.state.value.trim() !== "" ? this.props.onSuccess({ name: this.state.value, card: this.state.card._id }) : this.props.onCancel()} />
                </Modal.Actions>
            </div>
        )
    }
