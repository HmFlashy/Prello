...
module.exports = { Item: mongoose.model("Item", Item), CheckList: mongoose.model("CheckList", CheckList), Card: mongoose.model("Card", Card), CardInformation: mongoose.model("cardInformation", cardInformation) }